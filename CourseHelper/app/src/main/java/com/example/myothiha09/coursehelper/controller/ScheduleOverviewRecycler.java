...
public class ScheduleOverviewRecycler extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Toast.makeText(getContext(), "Click the schedule to view it visually", Toast.LENGTH_LONG).show();
        ...
        for(final ArrayList<Section> sections: list) {
            ...
            for (Section section: sections) {
                ...
                String meetingTimes = "Meeting Times: " + section.getMeetingTimes().toString();
